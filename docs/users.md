...
قمنا بمُنتهى البساطة باستيراد الدالة `login_user` من الإضافة واستخدامها للتحقق من بيانات المُستخدِم عبر استدعاء `(user)login_user`. يمكنك إضافة خاصة تسجيل خروج المُستخدِم الحالي عبر استدعاء الدالة `()logout_user`.
...
<br/><br/>
"لا يجدر بنا السؤال عن كلمة المرور مرّتين، فينبغي علينا أن نسأل عنها مرَّة واحدة ونتأكّد أن تعمل ميزة 'إعادة كلمة المرور' بسلاسة ومثاليّة."
<br/><br/>
...
<li>استخدام إضافة Flask-Login لمُصادِقة المُستخدمين لكي تتجنب إدارة بيانات الجلسة يدوياً.</li>
